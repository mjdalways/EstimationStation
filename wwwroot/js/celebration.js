...
const DEFAULT_CELEBRATION = {
    ...
    lavaColor:               '#ff4500',
    seasonalTheme:           false,
    seasonalHalloween:       false,
    seasonalChristmas:       false,
    seasonalNewYear:         false,
    seasonalValentine:       false,
    seasonalSpring:          false,
    seasonalSummer:          false,
    seasonalAutumn:          false,
    seasonalThanksgiving:    false,
    seasonalDeepWinter:      false,
    seasonalLunarNew:        false,
    seasonalAwards:          false,
    seasonalPancakeDay:      false,
    seasonalPiDay:           false,
    seasonalStPatricks:      false,
    seasonalHoli:            false,
    seasonalHanami:          false,
    seasonalAprilFools:      false,
    seasonalEarthDay:        false,
    seasonalRamadan:         false,
    seasonalMayDay:          false,
    seasonalStarWarsDay:     false,
    seasonalPride:           false,
    seasonalOceanWeek:       false,
    seasonalSolstice:        false,
    seasonalIndependence:    false,
    seasonalTanabata:        false,
    seasonalBastille:        false,
    seasonalAugBankHoliday:  false,
    seasonalBackToSchool:    false,
    seasonalOktoberfest:     false,
    seasonalMidAutumn:       false,
    seasonalSpaceWeek:       false,
    seasonalDayOfDead:       false,
    seasonalBonfireNight:    false,
    seasonalDiwali:          false,
    seasonalRemembrance:     false,
    seasonalBoxingDay:       false,
    seasonalWinterSolstice:  false,
    seasonalEndOfYear:       false,
    seasonalMlkDay:          false,
    seasonalPresidentsDay:   false,
    seasonalMemorialDay:     false,
    seasonalJuneteenth:      false,
    seasonalLaborDay:        false,
    seasonalIndigenousDay:   false,
    seasonalVeteransDay:     false,
    seasonalMothersDay:      false,
    seasonalFathersDay:      false,
    seasonalMotheringSunday: false,
    ...
    finisherThreshold:       4,
    pokerReveal:             false,
    revealSpeedBadges:       false,
    revealHotCold:           false,
    revealVoteDist:          false,
    revealParticles:         false,
    ...
    suspenseOrdering:        false,
    consensusSupernova:      false,
